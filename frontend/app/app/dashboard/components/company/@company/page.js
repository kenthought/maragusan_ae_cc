...
import CompanyDialog from "@/app/modals/components/company_dialog";
  ...
  return (
    <>
      <Autocomplete
        ...
        size="small"
        isOptionEqualToValue={(option, value) => option.company === value.title}

...
import ScheduleDialog from "@/app/modals/components/schedule_dialog";
      ...
      <TableRow>
        <StyledTableCell padding="checkbox">
          <Checkbox
            ...
            inputProps={{
              "aria-label": "select all schedule",
            }}
          />
        </StyledTableCell>
            ...
            <Tooltip title="Delete">
              <IconButton
                onClick={() => {
                  ...
                  axiosInstance
                    .delete("components/schedule/" + str)
                    .then((response) => {
                      handleSuccessful(
                        true,
                        "Deleted " +

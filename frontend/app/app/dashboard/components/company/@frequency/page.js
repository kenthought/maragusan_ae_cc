...
import FrequencyDialog from "@/app/modals/components/frequency_dialog";
      ...
      <TableRow>
        <StyledTableCell padding="checkbox">
          <Checkbox
            ...
            inputProps={{
              "aria-label": "select all frequency",
            }}
          />
        </StyledTableCell>
            ...
            <Tooltip title="Delete">
              <IconButton
                onClick={() => {
                  ...
                  axiosInstance
                    .delete("components/frequency/" + str)
                    .then((response) => {
                      handleSuccessful(
                        true,
                        "Deleted " +
...
export default function Frequency() {
  ...
  return (
    <>
        ...
        <Box sx={{ width: "100%" }}>
          <Paper sx={{ width: "100%", mb: 2 }}>
            ...
            <EnhancedTableToolbar
              ...
              setOpenFrequencyDialog={setOpenFrequencyDialog}
      ...
      <FrequencyDialog
        openFrequencyDialog={openFrequencyDialog}
        setOpenFrequencyDialog={setOpenFrequencyDialog}
        setSuccessText={setSuccessText}
        setIsSuccess={setIsSuccess}
        mutate={mutate}

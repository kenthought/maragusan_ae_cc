...
import BankDialog from "@/app/modals/components/bank_dialog";
  ...
  return (
    <>
      <Autocomplete
        ...
        size="small"
        isOptionEqualToValue={(option, value) => option.bank === value.title}
...
export default function Bank() {
  const { data, error, isLoading, mutate } = useSWR("components/bank", fetcher);

...
export default function ExpensesView(props) {
  const { data, expenses_category } = props;
          ...
          <Table aria-label="simple table" size="small">
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell>{data.new_data.expenses_description}</TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell>
                  {
                    expenses_category.find(
                      (x) => x.id == data.new_data.expenses_category
                    ).expenses_category
                  }
                </TableCell>
              </TableRow>
        ...
        <TableContainer>
          <Table aria-label="simple table" size="small">
            ...
            <TableBody>
              ...
              <TableRow>
                <TableCell>Expenses Description:</TableCell>
                <TableCell>{data.old_data.expenses_description}</TableCell>
                <TableCell>{data.new_data.expenses_description}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Expenses Category:</TableCell>
                <TableCell>
                  {
                    expenses_category.find(
                      (x) => x.id == data.old_data.expenses_category
                    ).expenses_category
                  }
                </TableCell>
                <TableCell>

          ...
          <Table aria-label="simple table" size="small">
            <TableBody>
              ...
              <TableRow>
                ...
                <TableCell colSpan={2}>
                  {data.new_data.asset_description}
                </TableCell>
              </TableRow>
              <TableRow>
                ...
                <TableCell colSpan={2}>
                  {
                    asset_type.find((x) => x.id == data.new_data.asset_type)
                      .asset_type
                  }
                </TableCell>
              </TableRow>
        ...
        <TableContainer>
          <Table aria-label="simple table" size="small">
            ...
            <TableBody>
              ...
              <TableRow>
                <TableCell>Asset description</TableCell>
                <TableCell>{data.old_data.asset_description}</TableCell>
                <TableCell>{data.new_data.asset_description}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell>Asset type</TableCell>
                <TableCell>
                  {
                    asset_type.find((x) => x.id == data.old_data.asset_type)
                      .asset_type
                  }
                </TableCell>
                <TableCell>

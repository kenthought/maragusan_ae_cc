...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='municipality', to='components.province'),
        ),
        migrations.AddField(
            model_name='municipality',
            name='user',
        ...
        migrations.AddField(
            model_name='barangay',
            name='municipality',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='barangay', to='components.municipality'),
        ),
        migrations.AddField(
            model_name='barangay',
            name='province',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='barangay', to='components.province'),
        ),
        migrations.AddField(
            model_name='barangay',
            name='user',

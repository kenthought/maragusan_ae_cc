...
from receivables.views.savings_ledger_views import *
...
urlpatterns = [
    ...
    path("savings-ledger/", SavingsLedgerList.as_view()),
    path("savings-ledger/<int:receivables>/", SavingsLedgerDetail.as_view()),
]
